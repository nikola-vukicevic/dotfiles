...
//	{ MODKEY,	            XK_i,       shiftviewclients,  { .i = -1 } },
	...
	{ MODKEY, XK_F9,      spawn, SHCMD("setxkbmap -layout us                -option caps:escape ; xmodmap -e 'clear lock' ; pkill -RTMIN+17 dwmblocks") },
	{ MODKEY, XK_F10,     spawn, SHCMD("setxkbmap -layout rs -variant latin -option caps:escape ; xmodmap -e 'clear lock' ; pkill -RTMIN+17 dwmblocks") },
	{ MODKEY, XK_F11,     spawn, SHCMD("setxkbmap -layout rs                -option caps:escape ; xmodmap -e 'clear lock' ; pkill -RTMIN+17 dwmblocks") },
	{ MODKEY, XK_F12,     spawn, SHCMD("scrot ~/slike/screenshots/%b%d::%H%M%S.png")                                                                    },  
	{ MODKEY, XK_Shift_L, spawn, SHCMD("promena_tastature")                                                                                             },
