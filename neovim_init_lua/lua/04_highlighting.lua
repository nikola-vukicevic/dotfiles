...
if basicHL == true then
	...
	vim.cmd("hi Comment                gui=NONE guifg=#545560")
	-- vim.cmd("hi Comment                gui=NONE guifg=#60616a")
	...
	vim.api.nvim_set_hl ( 0 , "FloatBorder" ,       { bg = None, fg='#64656a', bold = true } )  -- "#8080a0"
	vim.api.nvim_set_hl ( 0 , "FloatTitle" ,        { bg='#272935',            bold = true } )  -- "#8080a0"
	vim.api.nvim_set_hl ( 0 , "ToggleTermBorder" ,  { bg = None, fg='#64656a', bold = true } )  -- "#8080a0"
...
if TelescopeHL == true then
	...
	vim.api.nvim_set_hl ( 0 , "TelescopeNormal" ,         { bg = "#272935"                   } ) --"#2c303d",                } )
...
-- Breadcrumbs za QF:
-- ------------------
vim.api.nvim_set_hl ( 0 , "BreadcrumbsQfFile" ,           { fg = "#7fc29b" } )
vim.api.nvim_set_hl ( 0 , "BreadcrumbsQfModule" ,         { fg = "#7fc29b" } )
vim.api.nvim_set_hl ( 0 , "BreadcrumbsQfNamespace" ,      { fg = "#80a0f0" } )
vim.api.nvim_set_hl ( 0 , "BreadcrumbsQfPackage" ,        { fg = "#80a0f0" } )
vim.api.nvim_set_hl ( 0 , "BreadcrumbsQfClass" ,          { fg = "#f0a080" } )
vim.api.nvim_set_hl ( 0 , "BreadcrumbsQfMethod" ,         { fg = "#80a0f0" } )
vim.api.nvim_set_hl ( 0 , "BreadcrumbsQfProperty" ,       { fg = "#80a0f0" } )
vim.api.nvim_set_hl ( 0 , "BreadcrumbsQfField" ,          { fg = "#80a0f0" } )
vim.api.nvim_set_hl ( 0 , "BreadcrumbsQfConstructor" ,    { fg = "#80a0f0" } )
vim.api.nvim_set_hl ( 0 , "BreadcrumbsQfEnum" ,           { fg = "#80a0f0" } )
vim.api.nvim_set_hl ( 0 , "BreadcrumbsQfInterface" ,      { fg = "#80a0f0" } )
vim.api.nvim_set_hl ( 0 , "BreadcrumbsQfFunction" ,       { fg = "#80a0f0" } )
vim.api.nvim_set_hl ( 0 , "BreadcrumbsQfVariable" ,       { fg = "#80a0f0" } )
vim.api.nvim_set_hl ( 0 , "BreadcrumbsQfConstant" ,       { fg = "#80a0f0" } )
vim.api.nvim_set_hl ( 0 , "BreadcrumbsQfString" ,         { fg = "#80a0f0" } )
vim.api.nvim_set_hl ( 0 , "BreadcrumbsQfNumber" ,         { fg = "#f49fbc" } )
vim.api.nvim_set_hl ( 0 , "BreadcrumbsQfBoolean" ,        { fg = "#b480f0" } )
vim.api.nvim_set_hl ( 0 , "BreadcrumbsQfArray" ,          { fg = "#c0d0f7" } )
vim.api.nvim_set_hl ( 0 , "BreadcrumbsQfObject" ,         { fg = "#80a0f0" } )
vim.api.nvim_set_hl ( 0 , "BreadcrumbsQfKey" ,            { fg = "#80a0f0" } )
vim.api.nvim_set_hl ( 0 , "BreadcrumbsQfNull" ,           { fg = "#80a0f0" } )
vim.api.nvim_set_hl ( 0 , "BreadcrumbsQfEnumMember" ,     { fg = "#80a0f0" } )
vim.api.nvim_set_hl ( 0 , "BreadcrumbsQfStruct" ,         { fg = "#f49fbc" } )
vim.api.nvim_set_hl ( 0 , "BreadcrumbsQfEvent" ,          { fg = "#80a0f0" } )
vim.api.nvim_set_hl ( 0 , "BreadcrumbsQfOperator" ,       { fg = "#80a0f0" } )
vim.api.nvim_set_hl ( 0 , "BreadcrumbsQfTypeParameter" ,  { fg = "#80a0f0" } )
vim.api.nvim_set_hl ( 0 , "BreadcrumbsQfMacro" ,          { fg = "#80a0f0" } )
-- -------------------------------------------------------------------------- --
