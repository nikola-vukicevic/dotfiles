...
-- ------ -----------------------------------------------------------------------
vim.keymap.set( "n" , "<leader>p" , ":lua FormatiranjeIzvornogKoda('n')<cr>" , opts_nr )
vim.keymap.set( "v" , "<leader>p" , ":lua FormatiranjeIzvornogKoda('v')<cr>" , opts_nr )
...
-- vim.keymap.set( "n" , "<leader><F2>" , ":lua Snacks.picker.files()<cr>" ,                                              opts_nr )
...
vim.keymap.set( "n" , "<leader>t" ,    ":lua require('toggleterm.terminal').Terminal:new({ close_on_exit=true, display_name='[Terminal]' }):toggle()<cr>" ,                                          opts_snr )
-- vim.keymap.set( "n" , "<leader>t" ,    ":ToggleTerm name='[Terminal]'<cr>" ,                                          opts_snr )
vim.keymap.set( "n" , "<F3>" ,         ":Alpha<cr>" ,                                                                  opts_nr )
-- vim.keymap.set( "n" , "<leader><F3>" , ":Telescope aerial<cr>" ,                                                       opts_nr )
-- vim.keymap.set( "n" , "<F4>" ,         ":lua Snacks.picker.buffers()<cr>" ,                  opts_snr )
-- vim.keymap.set( "n" , "<M-u>" ,        ":lua Snacks.picker.buffers()<cr>" ,                  opts_snr )
-- vim.keymap.set( "n" , "<leader><F4>" , ":lua Snacks.picker.grep({ on_show = PressI })<cr>" , opts_snr )
-- vim.keymap.set( "n" , "<M-s>" ,        ":lua Snacks.picker.grep({ on_show = PressI })<cr>" , opts_snr )
-- vim.keymap.set( "n" , "<F4>" ,         ":lua BufferSwitcher()<cr>", opts_nr )
vim.keymap.set( "n" , "<F4>" ,  ":Telescope buffers<cr>" ,             opts_nr )
-- vim.keymap.set( "n" , "<M-u>" , ":lua QfBufferSwitcher()<cr>" ,        opts_snr )
vim.keymap.set( "n" , "<M-u>" , ":Telescope buffers<cr>" ,            opts_snr )
-- vim.keymap.set( "n" , "<M-u>" , ":lua SimpleBufferSwitcher()<cr>" ,   opts_snr )
vim.keymap.set( "n" , "<M-z>" , ":lua PronalazenjeNaslova()<cr>" ,     opts_nr )
...
vim.api.nvim_create_autocmd('LspAttach', {
	...
	callback = function(ev)
		...
		vim.keymap.set('n', '<leader>r', ":lua LSPRenamePoziv()<cr>", opts_snr)
		...
		vim.keymap.set('n', '<M-e>',    ":lua GetLspReferences()<cr>",       opts)
		-- vim.keymap.set('n', '<M-e>', ":Telescope lsp_references<cr>", opts)
		-- vim.keymap.set('n', '<M-e>',    ":lua vim.lsp.buf.references()<cr>", opts)
