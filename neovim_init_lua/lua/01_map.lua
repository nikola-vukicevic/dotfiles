...
vim.keymap.set( "n" , "<F4>" ,         ":lua Snacks.picker.buffers()<cr>" ,                  opts_nr )
vim.keymap.set( "n" , "<M-u>" ,        ":lua Snacks.picker.buffers()<cr>" ,                  opts_nr )
vim.keymap.set( "n" , "<leader><F4>" , ":lua Snacks.picker.grep({ on_show = PressI })<cr>" , opts_nr )
vim.keymap.set( "n" , "<M-s>" ,        ":lua Snacks.picker.grep({ on_show = PressI })<cr>" , opts_nr )
