...
vim.keymap.set( "v" , "<F5>" ,         ":lua UokviravanjeVisual()<cr>" , { desc = "" , remap = false } )
...
vim.keymap.set( "" , "<leader>y" , ":set wrap!<cr>" ,    { desc = "" , remap = true } )
vim.keymap.set( "" , "<F11>" ,     ":VimadeToggle<cr>" , { desc = "" , remap = true } )
vim.keymap.set( "" , "<F11>" ,     ":bd<cr>" ,           { desc = "" , remap = true } )
vim.keymap.set( "" , "<F12>" ,     ":qa<cr>" ,           { desc = "" , remap = true } )
-- " ----- "
